/**
 * FlightDepartureRow.tsx — Single row on the flight DEPARTURES board
 *
 * Dot-matrix board row for one outbound flight. Modelled on
...
interface FlightDepartureRowProps {
...
export default function FlightDepartureRow({
  departure,
  onClick,
  className,
}: FlightDepartureRowProps) {
